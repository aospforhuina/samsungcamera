...
.field private transient reflected:Lz6/b;
...
.method public varargs call([Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->getReflected()Lz6/b;

    move-result-object p0

    invoke-interface {p0, p1}, Lz6/b;->call([Ljava/lang/Object;)Ljava/lang/Object;
...
.method public callBy(Ljava/util/Map;)Ljava/lang/Object;
    ...
    invoke-interface {p0, p1}, Lz6/b;->callBy(Ljava/util/Map;)Ljava/lang/Object;
...
.method public compute()Lz6/b;
    .locals 1

    .line 1
    iget-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Lz6/b;

    if-nez v0, :cond_0

    .line 2
    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->computeReflected()Lz6/b;

    move-result-object v0

    .line 3
    iput-object v0, p0, Lkotlin/jvm/internal/c;->reflected:Lz6/b;

    :cond_0
    return-object v0
.end method

.method protected abstract computeReflected()Lz6/b;
.end method
...
.method public getAnnotations()Ljava/util/List;
    ...
    invoke-interface {p0}, Lz6/a;->getAnnotations()Ljava/util/List;
...
.method public getOwner()Lz6/e;
    ...
    invoke-static {v0}, Lkotlin/jvm/internal/x;->c(Ljava/lang/Class;)Lz6/e;
...
.method public getParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, Lz6/b;->getParameters()Ljava/util/List;
...
.method protected getReflected()Lz6/b;
    .locals 1

    .line 1
    invoke-virtual {p0}, Lkotlin/jvm/internal/c;->compute()Lz6/b;
...
.method public getReturnType()Lz6/l;
    .locals 0
    ...
    invoke-interface {p0}, Lz6/b;->getReturnType()Lz6/l;
...
.method public getTypeParameters()Ljava/util/List;
    ...
    invoke-interface {p0}, Lz6/b;->getTypeParameters()Ljava/util/List;
...
.method public getVisibility()Lz6/m;
    .locals 0
    ...
    invoke-interface {p0}, Lz6/b;->getVisibility()Lz6/m;
...
.method public isAbstract()Z
    ...
    invoke-interface {p0}, Lz6/b;->isAbstract()Z
...
.method public isFinal()Z
    ...
    invoke-interface {p0}, Lz6/b;->isFinal()Z
...
.method public isOpen()Z
    ...
    invoke-interface {p0}, Lz6/b;->isOpen()Z
...
.method public isSuspend()Z
    ...
    invoke-interface {p0}, Lz6/b;->isSuspend()Z
