...
.method public static isPkgEnabled(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    const-string v0, "isPkgEnabled, Could not find "
...
.method public static startCheckDownloadable(Landroid/content/Context;Ljava/lang/String;)V
    .locals 1

    .line 1
    invoke-static {p0}, Lcom/sec/android/app/camera/util/Util;->isNetworkConnected(Landroid/content/Context;)Z
    ...
    const-string p1, "stub cannot be checked because permission of using network was not enabled"
    ...
    invoke-virtual {v0, p0, p1}, Lcom/sec/android/app/camera/provider/AppUpdateCheckManager;->checkDownloadableApp(Landroid/content/Context;Ljava/lang/String;)V

    return-void
.end method

.method public static startPackageCheck(Landroid/content/Context;Ljava/lang/String;)V
    .locals 2
    ...
    .line 2
    :cond_0
    invoke-static {p0, p1}, Lcom/sec/android/app/camera/util/PackageUtil;->isPackageExisted(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 4
    :cond_1
    invoke-static {p0, p1}, Lcom/sec/android/app/camera/util/AppsStubUtil;->isStubCallAvailable(Landroid/content/Context;Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_2

    invoke-static {p0, p1}, Lcom/sec/android/app/camera/util/AppsStubUtil;->needToCheckStub(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 5
    invoke-static {p0, p1}, Lcom/sec/android/app/camera/util/PackageUtil;->startCheckDownloadable(Landroid/content/Context;Ljava/lang/String;)V
