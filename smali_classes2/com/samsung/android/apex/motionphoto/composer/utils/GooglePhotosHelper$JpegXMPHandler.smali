...
.method private static findPosition(Ljava/lang/String;)J
    ...
    const-string/jumbo v0, "this is not valid markers"
    ...
    const-string/jumbo v0, "this is not \'JPEG\' file"
...
.method private static reserve(Ljava/lang/String;I)J
    ...
    const-string/jumbo v2, "size before reserving xmp: "
    ...
    const-string/jumbo v1, "size after reserving xmp: "
...
.method private static write(Ljava/lang/String;JJJ)V
    ...
    const-string/jumbo v5, "write: path=%s, pos=%d, len=%d, offset=%d"
    ...
    invoke-static/range {v7 .. v12}, Lcom/samsung/android/apex/motionphoto/composer/utils/GooglePhotosHelper;->access$100(Lcom/samsung/android/apex/motionphoto/composer/utils/GooglePhotosHelper$MimeType;IJJ)Lc/d;
    ...
    invoke-direct {v5}, Lf/d;-><init>()V

    .line 11
    invoke-virtual {v5, v6}, Lf/d;->y(Z)Lf/d;

    .line 12
    invoke-virtual {v5, v6}, Lf/d;->A(Z)Lf/d;
    ...
    .line 14
    invoke-static {v2, v5}, Lc/e;->e(Lc/d;Lf/d;)[B
    ...
    const-string/jumbo v7, "xmp size[marker(2) + length(2) + data(variable)]:"
