...
.method static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lcom/samsung/android/ocr/MOCRConstants$MOCRImageType;

    const-string v3, "SPenInput"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4, v4}, Lcom/samsung/android/ocr/MOCRConstants$MOCRImageType;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/samsung/android/ocr/MOCRConstants$MOCRImageType;->SPenInput:Lcom/samsung/android/ocr/MOCRConstants$MOCRImageType;

    .line 3
    new-instance v3, Lcom/samsung/android/ocr/MOCRConstants$MOCRImageType;

    const-string v5, "HorizontalDocument"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6, v6}, Lcom/samsung/android/ocr/MOCRConstants$MOCRImageType;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/samsung/android/ocr/MOCRConstants$MOCRImageType;->HorizontalDocument:Lcom/samsung/android/ocr/MOCRConstants$MOCRImageType;

    const/4 v5, 0x3

    new-array v5, v5, [Lcom/samsung/android/ocr/MOCRConstants$MOCRImageType;
    ...
    .line 4
    sput-object v5, Lcom/samsung/android/ocr/MOCRConstants$MOCRImageType;->$VALUES:[Lcom/samsung/android/ocr/MOCRConstants$MOCRImageType;
