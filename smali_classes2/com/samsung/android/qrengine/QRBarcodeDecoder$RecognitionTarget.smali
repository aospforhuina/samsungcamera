...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v3, v5, v6}, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;->QR:Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;
    ...
    invoke-direct {v5, v7, v8}, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;->DMC:Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;

    .line 5
    new-instance v7, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;

    const-string v9, "Linear_QR"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;->Linear_QR:Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;

    .line 6
    new-instance v9, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;

    const-string v11, "QR_DMC"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;->QR_DMC:Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;

    .line 7
    new-instance v11, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;

    const-string v13, "Barcode_QR_WECHAT"

    const/4 v14, 0x6

    invoke-direct {v11, v13, v14}, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;-><init>(Ljava/lang/String;I)V

    sput-object v11, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;->Barcode_QR_WECHAT:Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;

    .line 8
    new-instance v13, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;

    const-string v15, "Barcode_QR_DMC"

    const/4 v14, 0x7

    invoke-direct {v13, v15, v14}, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;-><init>(Ljava/lang/String;I)V

    sput-object v13, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;->Barcode_QR_DMC:Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;

    const/16 v15, 0x8

    new-array v15, v15, [Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;
    ...
    .line 9
    sput-object v15, Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;->$VALUES:[Lcom/samsung/android/qrengine/QRBarcodeDecoder$RecognitionTarget;
