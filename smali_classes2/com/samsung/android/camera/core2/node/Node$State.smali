...
.field public static final enum f:Lcom/samsung/android/camera/core2/node/Node$State;

.field private static final synthetic g:[Lcom/samsung/android/camera/core2/node/Node$State;
...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Lcom/samsung/android/camera/core2/node/Node$State;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/samsung/android/camera/core2/node/Node$State;->b:Lcom/samsung/android/camera/core2/node/Node$State;
    ...
    invoke-direct {v3, v5, v6}, Lcom/samsung/android/camera/core2/node/Node$State;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/samsung/android/camera/core2/node/Node$State;->c:Lcom/samsung/android/camera/core2/node/Node$State;

    .line 4
    new-instance v5, Lcom/samsung/android/camera/core2/node/Node$State;

    const-string v7, "DEINITIALIZING"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/samsung/android/camera/core2/node/Node$State;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/samsung/android/camera/core2/node/Node$State;->d:Lcom/samsung/android/camera/core2/node/Node$State;

    .line 5
    new-instance v7, Lcom/samsung/android/camera/core2/node/Node$State;

    const-string v9, "ACTIVATED"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/samsung/android/camera/core2/node/Node$State;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/samsung/android/camera/core2/node/Node$State;->f:Lcom/samsung/android/camera/core2/node/Node$State;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/samsung/android/camera/core2/node/Node$State;
    ...
    .line 6
    sput-object v9, Lcom/samsung/android/camera/core2/node/Node$State;->g:[Lcom/samsung/android/camera/core2/node/Node$State;
...
.method public static values()[Lcom/samsung/android/camera/core2/node/Node$State;
    ...
    sget-object v0, Lcom/samsung/android/camera/core2/node/Node$State;->g:[Lcom/samsung/android/camera/core2/node/Node$State;
...
# virtual methods
.method public a(Lcom/samsung/android/camera/core2/node/Node$State;)V
    .locals 4
...
.method public b(Lcom/samsung/android/camera/core2/node/Node$State;)Z
    .locals 0
