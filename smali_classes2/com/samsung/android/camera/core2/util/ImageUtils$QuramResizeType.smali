...
.field public static final enum f:Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;

.field private static final synthetic g:[Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;
...
.method static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;

    const-string v3, "BILINEAR_EX"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4, v4}, Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;-><init>(Ljava/lang/String;II)V

    sput-object v1, Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;->c:Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;

    .line 3
    new-instance v3, Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;

    const-string v5, "FOUR_SAMPLING"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6, v6}, Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;-><init>(Ljava/lang/String;II)V

    sput-object v3, Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;->d:Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;

    .line 4
    new-instance v5, Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;

    const-string v7, "LANCZOS"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8, v8}, Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;-><init>(Ljava/lang/String;II)V

    sput-object v5, Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;->f:Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;
    ...
    .line 5
    sput-object v7, Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;->g:[Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;
...
.method public static a()Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;
    .locals 1
...
.method public static values()[Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;
    ...
    sget-object v0, Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;->g:[Lcom/samsung/android/camera/core2/util/ImageUtils$QuramResizeType;
