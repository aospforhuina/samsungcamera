...
.method public constructor <init>(Lcom/sec/android/app/camera/interfaces/CameraContext;Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitContract$View;I)V
    ...
    .line 3
    iput-object p2, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mRequestedBokehFocusedRect:Ljava/util/Map;

    .line 4
    iput-object p2, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mFaceRect:[Landroid/graphics/Rect;
    ...
    .line 11
    iput-boolean p2, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mIsNightScreenFlashStarted:Z

    .line 12
    new-instance p2, Lcom/sec/android/app/camera/shootingmode/portrait/j0;

    invoke-direct {p2, p0}, Lcom/sec/android/app/camera/shootingmode/portrait/j0;-><init>(Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;)V
...
.method public static synthetic d(Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;)V
    .locals 0
...
.method private enableEngineEventListeners(Z)V
    ...
    .line 2
    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->isFrontCamera()Z
...
.method private enableManagers(Z)V
    ...
    .line 1
    iget-object p1, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mSmartSelfieAngleManager:Lcom/sec/android/app/camera/shootingmode/common/manager/SmartSelfieAngleManager;
    ...
    .line 3
    iget-object p1, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mSceneDetectionManager:Lcom/sec/android/app/camera/shootingmode/common/manager/SceneDetectionCallbackManager;

    if-nez p1, :cond_0

    .line 4
    new-instance p1, Lcom/sec/android/app/camera/shootingmode/common/manager/SceneDetectionCallbackManager;
    ...
    invoke-direct {p1, v0, v1}, Lcom/sec/android/app/camera/shootingmode/common/manager/SceneDetectionCallbackManager;-><init>(Lcom/sec/android/app/camera/interfaces/CameraContext;Lcom/sec/android/app/camera/interfaces/Engine;)V
...
.method private getBokehEffectKey()Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;
    ...
    invoke-static {v0, p0}, Lcom/sec/android/app/camera/util/BokehUtil;->getSingleBokehEffectLevelSettingKey(II)Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;
...
.method private hideNightScreenFlash(Z)V
    ...
    invoke-interface {v1, p1, v0, v2}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitContract$View;->hideNightScreenFlash(ZFI)V
...
.method private isNightModeButtonAvailable()Z
    ...
    invoke-interface {p0}, Lcom/sec/android/app/camera/shootingmode/portrait/PortraitBaseContract$View;->isBokehEffectListAnimationRunning()Z
...
.method private isShowEffectButtonAvailable()Z
    ...
    sget-object v1, Lcom/sec/android/app/camera/interfaces/MenuLayerManager$MenuId;->BACK_SINGLE_BOKEH_BEAUTY:Lcom/sec/android/app/camera/interfaces/MenuLayerManager$MenuId;
...
.method private showNightScreenFlash()V
    ...
    invoke-interface {p0, v0, v1}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitContract$View;->showNightScreenFlash(FF)V
...
.method private updateGuide(Lcom/sec/android/app/camera/util/BokehUtil$BokehCallbackState;)V
    ...
    .line 3
    :cond_1
    iget-boolean v0, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mIsNightScreenFlashStarted:Z
...
.method protected handleBackKey()Z
    ...
    invoke-interface {p0, v2}, Lcom/sec/android/app/camera/shootingmode/portrait/PortraitBaseContract$View;->setBokehLightingVisibility(Z)V
...
.method public onActivate()V
    ...
    .line 12
    invoke-interface {v1, v0, v2, v3}, Lcom/sec/android/app/camera/shootingmode/portrait/PortraitBaseContract$View;->refreshBokehSliderTablet(III)V
    ...
    iget-boolean v2, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mIsGuideSuccess:Z
    ...
    iget-object v1, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mUpdateGuideTextRunnable:Ljava/lang/Runnable;
    ...
    .line 22
    invoke-direct {p0, v5}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->enableManagers(Z)V

    .line 23
    invoke-direct {p0, v5}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->enableEngineEventListeners(Z)V

    .line 24
    invoke-direct {p0, v5}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->enableEngineCallbacks(Z)V
    ...
    invoke-virtual {v0, v4}, Lcom/sec/android/app/camera/shootingmode/common/manager/SceneDetectionCallbackManager;->setSceneDetectionMode(Z)V
    ...
    :cond_5
    invoke-virtual {p0, v4}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->setSuperNightMode(Z)V
    ...
    invoke-interface {v0, p0}, Lcom/sec/android/app/camera/shootingmode/portrait/PortraitBaseContract$View;->updateChildBackground(I)V
...
.method public onCameraSettingChanged(Lcom/sec/android/app/camera/interfaces/CameraSettings$Key;II)V
    ...
    .line 3
    :pswitch_0
    invoke-direct {p0, p3}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->handleSceneDetectionInfo(I)V
    ...
    .line 9
    invoke-interface {p1, v0, v1, v2}, Lcom/sec/android/app/camera/shootingmode/portrait/PortraitBaseContract$View;->refreshBokehSliderTablet(III)V
...
.method protected onCaptureEvent(Lcom/sec/android/app/camera/shootingmode/abstraction/AbstractShootingModePresenter$CaptureEvent;)V
    .locals 3
    ...
    .line 5
    :pswitch_1
    iget-object p1, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mRequestedBokehFocusedRect:Ljava/util/Map;
    ...
    iget-object v2, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mRequestedBokehFocusedRect:Ljava/util/Map;

    invoke-interface {p1, v2}, Lcom/sec/android/app/camera/interfaces/PreviewOverlayLayerManager;->updateFaceRect(Ljava/util/Map;)V

    .line 7
    iget-object p1, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mFaceRect:[Landroid/graphics/Rect;
    ...
    invoke-interface {p0, v0}, Lcom/sec/android/app/camera/shootingmode/portrait/PortraitBaseContract$View;->endNightShutterAnimation(Z)V

    goto :goto_0

    .line 13
    :pswitch_3
    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->isNightScene()Z
...
.method public onDbUpdateCompleted(Ljava/io/File;)V
    ...
    .line 5
    :try_start_2
    invoke-static {v1, p1}, Lcom/sec/android/app/camera/logging/SaLogUtil;->sendSALog(Ljava/lang/String;Ljava/lang/String;)V

    goto :goto_0

    .line 6
    :cond_0
    invoke-static {v2, p1}, Lcom/sec/android/app/camera/logging/SaLogUtil;->sendSALog(Ljava/lang/String;Ljava/lang/String;)V
...
.method public onFaceDetection([Landroid/graphics/Rect;)Z
    ...
    iput-object p1, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mFaceRect:[Landroid/graphics/Rect;
...
.method public onInactivate()V
    ...
    .line 7
    invoke-direct {p0, v4}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->enableEngineCallbacks(Z)V

    .line 8
    invoke-direct {p0, v4}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->enableEngineEventListeners(Z)V

    .line 9
    invoke-direct {p0, v4}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->enableManagers(Z)V
    ...
    .line 11
    invoke-direct {p0, v4}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->hideNightScreenFlash(Z)V

    .line 12
    :cond_1
    invoke-direct {p0, v4}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->setBokehFocusedRectHighlight(Z)V
    ...
    .line 16
    invoke-direct {p0, v4, v4}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->updateNightModeButton(ZZ)V

    .line 17
    invoke-direct {p0, v4}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->updateGuideVisibility(Z)V
    ...
    .line 19
    iput-object v0, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mCurrentShowingBokehState:Lcom/sec/android/app/camera/util/BokehUtil$BokehCallbackState;

    .line 20
    iput-boolean v4, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mIsGuideToastTimerExpired:Z

    .line 21
    iput-boolean v4, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mIsFaceDetected:Z

    .line 22
    iput-boolean v4, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mIsGuideSuccess:Z
...
.method public onNightScreenFlashStarted()V
    ...
    .line 2
    iput-boolean v0, p0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->mIsNightScreenFlashStarted:Z

    .line 3
    invoke-direct {p0}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->showNightScreenFlash()V
...
.method public onNightScreenFlashStopped()V
    ...
    .line 2
    invoke-direct {p0, v0}, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter;->hideNightScreenFlash(Z)V
...
.method public onVisibilityChanged(Lcom/sec/android/app/camera/interfaces/ViewVisibilityEventManager$ViewId;Z)V
    ...
    .line 1
    sget-object v0, Lcom/sec/android/app/camera/shootingmode/portrait/SingleBokehPortraitPresenter$1;->$SwitchMap$com$sec$android$app$camera$interfaces$ViewVisibilityEventManager$ViewId:[I
    ...
    sget-object v2, Lcom/sec/android/app/camera/interfaces/MenuLayerManager$MenuId;->BACK_SINGLE_BOKEH_BEAUTY:Lcom/sec/android/app/camera/interfaces/MenuLayerManager$MenuId;
    ...
    invoke-interface {p1, v2}, Lcom/sec/android/app/camera/interfaces/MenuLayerManager;->hideMenu(Lcom/sec/android/app/camera/interfaces/MenuLayerManager$MenuId;)V
    ...
    invoke-interface {p1, v0}, Lcom/sec/android/app/camera/interfaces/PreviewOverlayLayerManager;->enableFaceRectView(Z)V
