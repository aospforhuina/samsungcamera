...
.method static constructor <clinit>()V
    ...
    .line 2
    new-instance v1, Lcom/sec/android/app/camera/interfaces/ShootingModeFeature$SupportedFlashType;

    const-string v3, "PHOTO_FLASH"

    const/4 v4, 0x1

    invoke-direct {v1, v3, v4}, Lcom/sec/android/app/camera/interfaces/ShootingModeFeature$SupportedFlashType;-><init>(Ljava/lang/String;I)V

    sput-object v1, Lcom/sec/android/app/camera/interfaces/ShootingModeFeature$SupportedFlashType;->PHOTO_FLASH:Lcom/sec/android/app/camera/interfaces/ShootingModeFeature$SupportedFlashType;

    .line 3
    new-instance v3, Lcom/sec/android/app/camera/interfaces/ShootingModeFeature$SupportedFlashType;

    const-string v5, "PHOTO_TORCH"

    const/4 v6, 0x2

    invoke-direct {v3, v5, v6}, Lcom/sec/android/app/camera/interfaces/ShootingModeFeature$SupportedFlashType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/sec/android/app/camera/interfaces/ShootingModeFeature$SupportedFlashType;->PHOTO_TORCH:Lcom/sec/android/app/camera/interfaces/ShootingModeFeature$SupportedFlashType;

    .line 4
    new-instance v5, Lcom/sec/android/app/camera/interfaces/ShootingModeFeature$SupportedFlashType;

    const-string v7, "VIDEO_TORCH"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/sec/android/app/camera/interfaces/ShootingModeFeature$SupportedFlashType;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/sec/android/app/camera/interfaces/ShootingModeFeature$SupportedFlashType;->VIDEO_TORCH:Lcom/sec/android/app/camera/interfaces/ShootingModeFeature$SupportedFlashType;

    const/4 v7, 0x4

    new-array v7, v7, [Lcom/sec/android/app/camera/interfaces/ShootingModeFeature$SupportedFlashType;
    ...
    .line 5
    sput-object v7, Lcom/sec/android/app/camera/interfaces/ShootingModeFeature$SupportedFlashType;->$VALUES:[Lcom/sec/android/app/camera/interfaces/ShootingModeFeature$SupportedFlashType;
