...
.method public static synthetic a(Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;->lambda$execute$1()V

    return-void
.end method

.method public static synthetic b(Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;->lambda$execute$0()V
...
.method execute()V
    ...
    invoke-interface {v2}, Lcom/sec/android/app/camera/interfaces/RecordingManager;->startRecording()V
    :try_end_0
    ...
    new-instance v1, Lcom/sec/android/app/camera/engine/request/p4;

    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/engine/request/p4;-><init>(Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;)V
    ...
    new-instance v2, Lcom/sec/android/app/camera/engine/request/q4;

    invoke-direct {v2, p0}, Lcom/sec/android/app/camera/engine/request/q4;-><init>(Lcom/sec/android/app/camera/engine/request/StartBackgroundRecordingRequest;)V
