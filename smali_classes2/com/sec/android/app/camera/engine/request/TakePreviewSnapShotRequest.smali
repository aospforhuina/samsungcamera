...
.method public static synthetic a(Lcom/sec/android/app/camera/engine/request/TakePreviewSnapShotRequest;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/camera/engine/request/TakePreviewSnapShotRequest;->lambda$onTimeout$2()V

    return-void
.end method

.method public static synthetic b(Lcom/sec/android/app/camera/engine/request/TakePreviewSnapShotRequest;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/camera/engine/request/TakePreviewSnapShotRequest;->lambda$execute$0()V

    return-void
.end method

.method public static synthetic c(Lcom/sec/android/app/camera/engine/request/TakePreviewSnapShotRequest;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/camera/engine/request/TakePreviewSnapShotRequest;->lambda$onInterrupt$1()V
...
.method private synthetic lambda$execute$0()V
    ...
    invoke-interface {p0}, Lcom/sec/android/app/camera/interfaces/InternalEngine;->handlePreviewSnapShotError()V
...
.method execute()V
    ...
    new-instance v1, Lcom/sec/android/app/camera/engine/request/m5;

    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/engine/request/m5;-><init>(Lcom/sec/android/app/camera/engine/request/TakePreviewSnapShotRequest;)V
...
.method onInterrupt()V
    ...
    new-instance v1, Lcom/sec/android/app/camera/engine/request/n5;

    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/engine/request/n5;-><init>(Lcom/sec/android/app/camera/engine/request/TakePreviewSnapShotRequest;)V
...
.method onTimeout()V
    ...
    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/engine/request/l5;-><init>(Lcom/sec/android/app/camera/engine/request/TakePreviewSnapShotRequest;)V
