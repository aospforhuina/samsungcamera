.class Lcom/sec/android/app/camera/engine/request/CancelSingleTakeVideoRequest;
.super Lcom/sec/android/app/camera/engine/request/Request;
.source "CancelSingleTakeVideoRequest.java"
...
.method public static synthetic a(Lcom/sec/android/app/camera/engine/request/CancelSingleTakeVideoRequest;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/camera/engine/request/CancelSingleTakeVideoRequest;->lambda$execute$0()V

    return-void
.end method

.method public static synthetic b(Lcom/sec/android/app/camera/engine/request/CancelSingleTakeVideoRequest;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/camera/engine/request/CancelSingleTakeVideoRequest;->lambda$execute$1()V

    return-void
.end method

.method public static synthetic c(Lcom/sec/android/app/camera/engine/request/CancelSingleTakeVideoRequest;)V
    .locals 0

    invoke-direct {p0}, Lcom/sec/android/app/camera/engine/request/CancelSingleTakeVideoRequest;->lambda$execute$2()V
...
.method execute()V
    ...
    invoke-interface {v1}, Lcom/sec/android/app/camera/interfaces/RecordingManager;->cancelRecording()V

    .line 5
    iget-object v1, p0, Lcom/sec/android/app/camera/engine/request/Request;->mEngine:Lcom/sec/android/app/camera/interfaces/InternalEngine;

    new-instance v3, Lcom/sec/android/app/camera/engine/request/e;

    invoke-direct {v3, p0}, Lcom/sec/android/app/camera/engine/request/e;-><init>(Lcom/sec/android/app/camera/engine/request/CancelSingleTakeVideoRequest;)V
    ...
    invoke-interface {v1}, Lcom/sec/android/app/camera/interfaces/InternalEngine$RecordingEventListener;->onRecordingCancelled()V
    :try_end_0
    ...
    new-instance v1, Lcom/sec/android/app/camera/engine/request/g;

    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/engine/request/g;-><init>(Lcom/sec/android/app/camera/engine/request/CancelSingleTakeVideoRequest;)V
    ...
    new-instance v1, Lcom/sec/android/app/camera/engine/request/f;

    invoke-direct {v1, p0}, Lcom/sec/android/app/camera/engine/request/f;-><init>(Lcom/sec/android/app/camera/engine/request/CancelSingleTakeVideoRequest;)V
