...
.method public static declared-synchronized checkVersion(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
    ...
    invoke-direct {v1, v3, v4, v2}, Lw2/b;-><init>(III)V
    ...
    .line 8
    :cond_5
    new-instance v1, Lcom/google/vr/dynamite/client/d;

    invoke-direct {v1, p1, p2}, Lcom/google/vr/dynamite/client/d;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    .line 9
    invoke-static {v1}, Lcom/google/vr/dynamite/client/DynamiteClient;->getRemoteLibraryLoaderFromInfo(Lcom/google/vr/dynamite/client/d;)Lcom/google/vr/dynamite/client/c;
    ...
    .line 10
    :try_start_1
    invoke-virtual {p1, p0}, Lcom/google/vr/dynamite/client/c;->c(Landroid/content/Context;)Landroid/content/Context;

    move-result-object v2

    .line 11
    invoke-virtual {p1, p0}, Lcom/google/vr/dynamite/client/c;->b(Landroid/content/Context;)Lcom/google/vr/dynamite/client/ILoadedInstanceCreator;

    move-result-object p1

    .line 12
    invoke-static {v2}, Lcom/google/vr/dynamite/client/ObjectWrapper;->c(Ljava/lang/Object;)Lcom/google/vr/dynamite/client/IObjectWrapper;

    move-result-object v2

    invoke-static {p0}, Lcom/google/vr/dynamite/client/ObjectWrapper;->c(Ljava/lang/Object;)Lcom/google/vr/dynamite/client/IObjectWrapper;
    ...
    :try_end_1
    .catch Lw2/a; {:try_start_1 .. :try_end_1} :catch_0
    ...
    move-result p0
    :try_end_2
    .catch Lw2/a; {:try_start_2 .. :try_end_2} :catch_0
...
.method private static declared-synchronized getRemoteLibraryLoaderFromInfo(Lcom/google/vr/dynamite/client/d;)Lcom/google/vr/dynamite/client/c;
    .locals 3
    ...
    check-cast v2, Lcom/google/vr/dynamite/client/c;

    if-nez v2, :cond_0

    .line 2
    new-instance v2, Lcom/google/vr/dynamite/client/c;

    invoke-direct {v2, p0}, Lcom/google/vr/dynamite/client/c;-><init>(Lcom/google/vr/dynamite/client/d;)V
...
.method public static declared-synchronized loadNativeRemoteLibrary(Landroid/content/Context;Ljava/lang/String;Ljava/lang/String;)J
    ...
    .line 5
    invoke-static {v4}, Lcom/google/vr/dynamite/client/ObjectWrapper;->c(Ljava/lang/Object;)Lcom/google/vr/dynamite/client/IObjectWrapper;
