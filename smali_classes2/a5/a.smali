...
.method public constructor <init>(Landroid/content/Context;Lv4/c;)V
    ...
    .line 3
    iput-object p2, p0, La5/a;->b:Lv4/c;
...
.method public onFinish()I
    ...
    .line 1
    iget-object v0, p0, La5/a;->b:Lv4/c;
    ...
    .line 2
    iget-object v1, p0, La5/a;->a:Landroid/content/Context;
    ...
    .line 5
    :cond_1
    iget-object v1, p0, La5/a;->b:Lv4/c;

    invoke-virtual {v1}, Lv4/c;->i()Z
    ...
    iget-object v3, p0, La5/a;->b:Lv4/c;

    invoke-static {v1, v3}, Lk5/d;->p(Landroid/content/Context;Lv4/c;)V

    .line 7
    :cond_2
    iget-object v1, p0, La5/a;->c:Ljava/util/Map;

    invoke-static {v1}, Lz4/c;->a(Ljava/util/Map;)Ljava/util/Map;

    move-result-object v1

    sget-object v3, Lk5/d$b;->d:Lk5/d$b;

    invoke-static {v1, v3}, Lk5/d;->n(Ljava/util/Map;Lk5/d$b;)Ljava/lang/String;
    ...
    .line 9
    iget-object v4, p0, La5/a;->a:Landroid/content/Context;

    invoke-static {v4, v3}, Lk5/d;->k(Landroid/content/Context;Ljava/lang/String;)Z
    ...
    .line 10
    invoke-static {v3}, Lk5/b;->f(Ljava/lang/String;)V
    ...
    .line 23
    iget-object v6, p0, La5/a;->b:Lv4/c;

    invoke-virtual {v6}, Lv4/c;->k()Z
    ...
    invoke-virtual {v6}, Lv4/c;->f()Ljava/lang/String;
    ...
    .line 25
    sget-object v6, Lc5/c;->c:Lc5/c;

    invoke-virtual {v6}, Lc5/c;->a()Ljava/lang/String;
    ...
    .line 28
    sget-object v0, Lk5/d$b;->c:Lk5/d$b;

    invoke-static {v3, v0}, Lk5/d;->n(Ljava/util/Map;Lk5/d$b;)Ljava/lang/String;
    ...
    invoke-static {v0, v5, v3}, Lk5/d;->a(Landroid/content/Context;Landroid/content/ContentValues;Lv4/c;)V

    .line 31
    :cond_4
    iget-object v0, p0, La5/a;->a:Landroid/content/Context;

    invoke-static {v0}, Lk5/d;->f(Landroid/content/Context;)Z
    ...
    :cond_5
    :try_start_0
    iget-object p0, p0, La5/a;->a:Landroid/content/Context;
    ...
    iget-object p0, p0, La5/a;->b:Lv4/c;

    invoke-static {v0, v1, p0}, Lc5/d;->a(Landroid/content/Context;ILv4/c;)Lc5/b;

    move-result-object p0

    invoke-interface {p0, v3}, Lc5/b;->a(Ljava/util/Map;)I
