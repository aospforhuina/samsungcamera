...
.method private final e()Lz0/k;
    ...
    invoke-static {v1, v3}, Lb1/p;->j(ZLjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lz0/k;

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lz0/k;

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lz0/l;
    ...
    check-cast p0, Lcom/google/android/gms/common/api/internal/u;

    if-nez p0, :cond_0

    .line 5
    invoke-static {v1}, Lb1/p;->g(Ljava/lang/Object;)Ljava/lang/Object;
...
.method private final f(Lz0/k;)V
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(TR;)V"
    ...
    .line 1
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lz0/k;

    invoke-interface {p1}, Lz0/k;->c()Lcom/google/android/gms/common/api/Status;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->m:Lb1/k;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lz0/l;

    goto :goto_0

    .line 3
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f:Lz0/l;

    if-nez v0, :cond_1

    iget-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lz0/k;
    ...
    invoke-direct {v0, p0, p1}, Lcom/google/android/gms/common/api/internal/d0;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;La1/d0;)V
    ...
    .line 6
    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->e()Lz0/k;

    move-result-object v1

    invoke-virtual {p1, v0, v1}, Lcom/google/android/gms/common/api/internal/BasePendingResult$a;->a(Lz0/l;Lz0/k;)V
...
.method static bridge synthetic g(Lcom/google/android/gms/common/api/internal/BasePendingResult;)Lz0/k;
    .locals 0

    iget-object p0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Lz0/k;

    return-object p0
.end method

.method public static h(Lz0/k;)V
    .locals 2
    ...
    invoke-interface {v0}, Lz0/h;->release()V
    :try_end_0
...
# virtual methods
.method protected abstract a(Lcom/google/android/gms/common/api/Status;)Lz0/k;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final b(Lcom/google/android/gms/common/api/Status;)V
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->a(Lcom/google/android/gms/common/api/Status;)Lz0/k;

    move-result-object p1

    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->d(Lz0/k;)V
...
.method public final d(Lz0/k;)V
    ...
    invoke-static {v1, v2}, Lb1/p;->j(ZLjava/lang/Object;)V
    ...
    .line 4
    invoke-direct {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->f(Lz0/k;)V
    ...
    .line 6
    :cond_0
    invoke-static {p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h(Lz0/k;)V
