...
.field private final f:Li2/k;


# direct methods
.method private constructor <init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILi2/k;Landroid/graphics/Rect;)V
    .locals 1
    ...
    .line 11
    iput-object p5, p0, Lcom/google/android/material/datepicker/b;->f:Li2/k;
...
.method static a(Landroid/content/Context;I)Lcom/google/android/material/datepicker/b;
    ...
    .line 14
    invoke-static {p0, p1, v1}, Lf2/c;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    .line 25
    invoke-static {p0, v1, v0}, Li2/k;->b(Landroid/content/Context;II)Li2/k$b;
    ...
    invoke-direct/range {v5 .. v11}, Lcom/google/android/material/datepicker/b;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;Landroid/content/res/ColorStateList;ILi2/k;Landroid/graphics/Rect;)V
...
.method d(Landroid/widget/TextView;)V
    ...
    .line 3
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Li2/k;

    invoke-virtual {v0, v2}, Li2/g;->setShapeAppearanceModel(Li2/k;)V

    .line 4
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->f:Li2/k;

    invoke-virtual {v1, v2}, Li2/g;->setShapeAppearanceModel(Li2/k;)V

    .line 5
    iget-object v2, p0, Lcom/google/android/material/datepicker/b;->c:Landroid/content/res/ColorStateList;

    invoke-virtual {v0, v2}, Li2/g;->Y(Landroid/content/res/ColorStateList;)V
