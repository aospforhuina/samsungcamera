...
.method private final dfs(Ljava/util/List;Ljava/util/List;ILu6/l;)V
    .locals 2
    ...
    .line 2
    invoke-static {p2}, Ll6/q;->G(Ljava/lang/Iterable;)Ljava/util/List;

    move-result-object p0

    invoke-interface {p4, p0}, Lu6/l;->invoke(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p1, p2, v1, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILu6/l;)V

    .line 7
    invoke-static {p2}, Ll6/q;->q(Ljava/util/List;)Ljava/lang/Object;
...
.method static synthetic dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILu6/l;ILjava/lang/Object;)V
    .locals 0
    ...
    .line 2
    :cond_1
    invoke-direct {p0, p1, p2, p3, p4}, Landroidx/room/AmbiguousColumnResolver;->dfs(Ljava/util/List;Ljava/util/List;ILu6/l;)V

    return-void
.end method

.method private final rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lu6/q;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p3, p2, v3, v4}, Lu6/q;->invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final resolve([Ljava/lang/String;[[Ljava/lang/String;)[[I
    ...
    .line 9
    :cond_3
    invoke-static {}, Ll6/o0;->b()Ljava/util/Set;
    ...
    .line 11
    invoke-static {v2, v6}, Ll6/q;->p(Ljava/util/Collection;[Ljava/lang/Object;)Z
    ...
    :cond_4
    invoke-static {v2}, Ll6/o0;->a(Ljava/util/Set;)Ljava/util/Set;
    ...
    invoke-direct {v10, v0, v6, v11}, Landroidx/room/AmbiguousColumnResolver;->rabinKarpSearch(Ljava/util/List;[Ljava/lang/String;Lu6/q;)V
    ...
    .line 27
    :cond_9
    invoke-static {v14}, Ll6/q;->a(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-static/range {v11 .. v17}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILu6/l;ILjava/lang/Object;)V
    ...
    invoke-direct {v12, v0}, Landroidx/room/AmbiguousColumnResolver$resolve$4;-><init>(Lkotlin/jvm/internal/w;)V

    const/4 v13, 0x6

    const/4 v14, 0x0

    invoke-static/range {v8 .. v14}, Landroidx/room/AmbiguousColumnResolver;->dfs$default(Landroidx/room/AmbiguousColumnResolver;Ljava/util/List;Ljava/util/List;ILu6/l;ILjava/lang/Object;)V
    ...
    invoke-static {v0, v2}, Ll6/q;->m(Ljava/lang/Iterable;I)I
    ...
    invoke-static {v2}, Ll6/q;->F(Ljava/util/Collection;)[I
